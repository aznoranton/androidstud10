...
class Main extends StatelessWidget {
  ...
  final TextEditingController _controllerForB = TextEditingController();
        ...
        body: Center(
          child: Column(
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  stroki.Add(_controllerForB.text);
                  _controllerForB.text = "";
                },
                child: Text("Add B text"),
              ),
              Row(
                children: [
                  ElevatedButton(
            ...
            child: Builder(builder: (BuildContext innerContext) {
              return Center(
                ...
                children: [
                  ...
                  ElevatedButton(
                      onPressed: () => context.go("/pageA"),
                      child: Text(JustStr.of(innerContext).str)),
                  const SizedBox(
                    height: 20,
                  ),
                  ElevatedButton(
